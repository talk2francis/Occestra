...
**Monorepo** (npm workspaces, Node 22, TypeScript strict + `exactOptionalPropertyTypes`, **185 tests**):
...
- A monorepo with 185 passing tests, a cross-language EVM proof, and an `AGENTS.md` deviations log that records every expensive lesson honestly.
