...
export const CELEBRATE = {
  ...
  artifacts: [
    { kind: "plan", axes: { source_coverage: 90, date_validity: 90, schedule_feasibility: 85, uncertainty_disclosure: 85 } },
    { kind: "schedule", axes: { schedule_feasibility: 80, date_validity: 85, source_coverage: 80, uncertainty_disclosure: 75 } },
    { kind: "budget", axes: { budget_consistency: 90, source_coverage: 80, uncertainty_disclosure: 80, contingency: 75 } },
    { kind: "contingency", axes: { contingency: 85, uncertainty_disclosure: 90, source_coverage: 80, date_validity: 85 } },
    { kind: "guest_guide", axes: { uncertainty_disclosure: 90, source_coverage: 85, date_validity: 90, contingency: 85 } },
  ],
  passRate: 1,
  seal: {
...
export const TRIBUNAL_CASE = {
  ...
  before: {
    ...
    axes: { voice: 60, specificity: 45, factual_support: 60, structure: 55, platform_fit: 50 },
    pass: false,
    issues: [
  ...
  after: {
    ...
    axes: { voice: 68, specificity: 60, factual_support: 60, structure: 66, platform_fit: 58 },
    pass: false,
    repairs: 2,
  },
